...
Warning in kbal::kbal(X, treatment = data$Z, numdims = nc, printprogress = FALSE,  :
   "mixed_data"= TRUE, but one or more columns of "allx" designated as continuous by omission from "cat_columns" contain less than 10 unique values. Are you sure  all categorical variables are specified in "cat_columns"?
Warning in kbal::kbal(X, treatment = data$Z, numdims = nc, printprogress = FALSE,  :
